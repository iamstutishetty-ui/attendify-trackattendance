...
function SettingsTab() {
  ...
  return (
    <section className="space-y-4">
      ...
      <Button disabled={deleting} onClick={handleDeleteMine} className="h-11 w-full rounded-xl bg-[#f4a5a0] text-white hover:bg-[#ef8a83] dark:bg-[#c96a63] dark:hover:bg-[#b95a53]">
